...
class Arguments:
    def __init__(self):
        ...
        # Inventory
        self._parser.add_argument('--invent', type=float, default=1, help='Time')
        ...
        self._parser.add_argument('--TIU_eval', type=int, default=0, help='Evaluation with TIU = 1')
        ...
        # TIU constraint (refine)
        self._parser.add_argument('--TIU_eq', type=int, default=0)
        
        # Production 
        self._parser.add_argument('--pnn', type=float, default=1.0)
        
        # num 
        self._parser.add_argument('--No', type=int, default=1)
        self._parser.add_argument('--temp', type=int, default=0)
